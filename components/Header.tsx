...
import { Search, ShoppingCart, Shield, Store, Sparkles, Camera } from 'lucide-react'
          ...
          <form onSubmit={handleSearch} className="flex-1 max-w-2xl">
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-10 top-1/2 -translate-y-1/2 p-1.5 hover:bg-gray-100 dark:hover:bg-slate-700 rounded-md transition"
              ...
              <input
                ...
                className="w-full pl-10 pr-16 py-2 border border-gray-300 dark:border-slate-600 rounded-lg dark:bg-slate-700 dark:text-white"
              />
            </div>
          </form>
